...
New-AzResourceGroupDeployment -ResourceGroupName "magoni" -TemplateFile "/home/matthew/azurevwan/vmcreatetemplate.json" -TemplateParameterFile "/home/matthew/azurevwan/VM1parameters.json"
New-AzResourceGroupDeployment -ResourceGroupName "magoni" -TemplateFile "/home/matthew/azurevwan/vmcreatetemplate.json" -TemplateParameterFile "/home/matthew/azurevwan/VM2parameters.json"
